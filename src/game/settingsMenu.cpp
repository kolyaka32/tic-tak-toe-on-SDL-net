...
soundText{0.5, 0.7, {"Sounds", "Звуки", "Geräusche", "Гук"}, 1, 24, WHITE},
soundSlider{0.5, 0.76, 0.5, sounds.getVolume()},
exitButton{0.5, 0.85, {"Exit", "Выход", "Ausfahrt", "Выхад"}, 24, WHITE} {}
