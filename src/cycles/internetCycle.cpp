...
looseText(_app.window, 0.5, 0.38, {"You loose", "Вы проиграли", "Sie haben verloren", "Вы прайгралі"}, 30, WHITE),
winText(_app.window, 0.5, 0.38, {"Win", "Победа", "Sieg", "Перамога"}, 30, WHITE) {
    // Resetting flag
    if (!isRestarted()) {
